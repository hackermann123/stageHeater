...
# ============================================================================
RELAY_GPIO_PIN = 25  # GPIO4 on Raspberry Pi Compute Module
...
def main():
    ...
    if os.geteuid() != 0:
        ...
        print("Usage: sudo python3 script.py <target_temp_celsius>\n")
    ...
    if len(sys.argv) > 1:
        try:
            ...
            print("✗ Invalid target temperature. Usage: sudo python3 script.py <target_temp_celsius>")
            sys.exit(1)
    else:
